...
function Edit() {
  ...
  return (
    <>
    <button onClick={handleShow} style={{textDecoration:'none'}} className="btn btn-link text-warning d-flex align-items-center fw-bolder"><i style={{height:'34px'}} className="fa-solid fa-edit fa-2x"></i></button>
